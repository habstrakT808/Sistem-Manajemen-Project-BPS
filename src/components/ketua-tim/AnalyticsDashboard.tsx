...
export default function AnalyticsDashboard() {
  ...
  // File: src/components/ketua-tim/AnalyticsDashboard.tsx (Update fetchAnalyticsData function)
        ...
        <div className="border-0 shadow-xl rounded-xl overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            {project_performance.map((project, index) => (
              <div
                key={index}
                className="p-4 rounded-2xl border border-gray-100 hover:border-blue-200 hover:bg-blue-50 transition-all duration-300"
              >
        ...
        <div className="border-0 shadow-xl rounded-xl overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            {team_productivity.map((member, index) => (
              <div
                key={index}
                className="p-4 rounded-2xl border border-gray-100 hover:border-green-200 hover:bg-green-50 transition-all duration-300"
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="font-semibold text-gray-900">
                    {member.member_name}
